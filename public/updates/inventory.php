                    ...
                    <div class="container-fluid mt-n5">
                        <div class="toggle-card">
                            ...
                            <div class="slidediv" id="slidediv">
                                ...
                                <div class="header-left d-flex col-md-12" style="padding:10px;">
                                    <h6 class="mt-4" style="padding-right: 27%;">Spares Categories</h6>
                                </div> 

                                <div class="lists col-md-12">
                                    <a class="nav-link collapsed d-flex" id="icon-table" href="javascript:void(0);" data-toggle="collapse" data-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                        <div class="nav-link-icon"><i class="bi bi-plus-square" id="iconSide"></i></div>
                                        <div class="icon-table" style="padding-left: 5px;">Server</div>
                                    </a>
                                        
                                    <div class="collapse" id="collapseLayouts" data-parent="#accordionSidenav">
                                        <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavLayout">
                                            <a class="nav-link" href="#"><input type="checkbox" name="" id="">Static Navigation</a>
                                            <a class="nav-link" href="#"><input type="checkbox" name="" id="">Dark Sidenav</a>
                                            <a class="nav-link" href="#"><input type="checkbox" name="" id="">RTL Layout</a>
                            ...
                            <div class="table-slide">
                                <div class="card-header d-flex justify-content-end">
                                    <button class="btn btn-danger btn-sm"><i class="bi bi-filetype-pdf"></i>Export PDF</button>
                                    <button class="btn btn-success btn-sm"><i class="bi bi-filetype-csv"></i>Export CSV</button>
                                </div>
                                
                                <div class="card-body">
    
                                    <button class="btn btn-warning   change-icon d-flex" id="slidebutton">
                                        <i class="fa fa-filter" id="icon"></i>
                                    </button>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="display:flex; justify-content:center; gap:5px;">
                                                        ...
                                                        <button class="btn btn-warning btn-icon btn-sm" title="Pull Out" type="button" id="Confirm" data-toggle="modal" data-target="#staticBackdrop">
                                                            <i data-feather="log-out"></i>
                                                        </button>
                                                        <button class="btn btn-danger btn-icon btn-sm" title="Delete" type="button" id="Reject">
                                                            <i data-feather="x"></i>
                                                        </button>
                                                    </td>
                                                </tr>
