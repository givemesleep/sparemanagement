                        ...
                        <div class="container-fluid">
                            <div class="page-header-content">
                                <h1 class="page-header-title">
                                    ...
                                    <span>Approval for Delivered Spares</span>
                                </h1>
                    ...
                    <div class="container-fluid mt-n5">
                        <div class="card">
                                ...
                                <div class="card-header">
                                    This table displays the spares added by members and to be approved by admins.
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="display:flex; justify-content:center; gap:5px;">
                                                        <button class="btn btn-dark btn-icon btn-sm" type="button" value="view">
                                                            <i data-feather="eye"></i>
                                                        </button>
                                                        <button class="btn btn-success btn-icon btn-sm" type="button" id="Confirm">
                                                            <i data-feather="check-circle"></i>
                                                        </button>
                                                        <button class="btn btn-danger btn-icon btn-sm" type="button" id="Reject">
                                                            <i data-feather="x"></i>
                                                        </button>
                                                    </td>
                                                </tr>
        ...
        <script>
            ...
            submitBtn.addEventListener("click", function () {
                const swalWithBootstrapButtons = Swal.mixin({
                    ...
                    title: "Are you sure you want to approve this hardware?",
                    icon: "warning",
            ...
            rejectBtn.addEventListener("click", function () {
                const swalWithBootstrapButtons = Swal.mixin({
                    ...
                    swalWithBootstrapButtons.fire({
                    title: "Are you sure you want to reject this hardware?",
                    icon: "warning",
                    showCancelButton: true,
